...
export function HomeTab() {
  ...
  return (
    <div className="space-y-4 pb-safe pb-8">
        ...
        {isMonthlyExpensesExpanded && operatingExpenses.length > 0 && (
          <div className="mt-4 pt-4 border-t" style={{ borderColor: 'rgba(255, 255, 255, 0.1)' }}>
            <div className="space-y-2">
              <div className="text-sm font-semibold text-secondary mb-2">Expense Breakdown</div>
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-3">
                        <span className="text-sm" style={{ color: 'var(--game-secondary)' }}>
                          {isExpanded ? '▼' : '▶'}
                        </span>
                        <div className="flex items-center gap-2">
                          ...
                          {isCurrentMonth && (
                            <span className="text-white px-2 py-0.5 rounded text-sm font-semibold" style={{ backgroundColor: 'var(--game-primary)' }}>Active</span>
                          )}
                        </div>
                      </div>
