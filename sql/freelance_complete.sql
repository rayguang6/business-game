-- ============================================
-- FREELANCE INDUSTRY - Complete Setup
-- ============================================
...
VALUES 
  (
    ...
    20,
    1,
    '[{"metric": "reputationMultiplier", "type": "add", "value": 0.1}]'::jsonb,
    'learned-design',
    '[]'::jsonb
  ),
  (
  ...
  (
    ...
    1,
    '[
      {"metric": "reputationMultiplier", "type": "add", "value": 0.3},
  ...
  (
    ...
    1,
    '[
      {"metric": "reputationMultiplier", "type": "add", "value": 0.15},
...
VALUES 
  (
    ...
    2,
    180,
    '[{"metric": "reputationMultiplier", "type": "add", "value": 0.05, "durationSeconds": 1800}]'::jsonb,
    NULL,
    '[]'::jsonb
  ),
  (
    ...
    5,
    300,
    '[{"metric": "reputationMultiplier", "type": "add", "value": 0.15, "durationSeconds": 3600}]'::jsonb,
    NULL,
  ...
  (
    ...
    12,
    900,
    '[{"metric": "reputationMultiplier", "type": "add", "value": 0.2, "durationSeconds": 7200}]'::jsonb,
    NULL,
    '[]'::jsonb
  )
ON CONFLICT (id) DO UPDATE SET
...
-- Step 6: Events (6 items - mix of opportunities and risks)
-- Event 1: Client Referral (Opportunity)
      ...
      "consequences": [
        {
          ...
          "effects": [
            ...
            {"type": "reputation", "amount": 5, "label": "Word of mouth"}
          ]
        }
      ]
    },
  ...
  '[
    {
      ...
      "consequences": [
        ...
        },
        {
          ...
          "weight": 30,
          "effects": [
            {"type": "reputation", "amount": -2, "label": "Frustration"}
          ]
        }
      ]
    },
      ...
      "consequences": [
        ...
        },
        {
          ...
          "effects": [
            ...
            {"type": "reputation", "amount": -5, "label": "Bad experience"}
          ]
        }
      ]
    }
      ...
      "consequences": [
        {
          ...
          "effects": [
            ...
            {"type": "reputation", "amount": 2, "label": "Professional boundaries"}
          ]
        },
        {
          "id": "declined",
          ...
          "weight": 40,
          "effects": [
            {"type": "reputation", "amount": -3, "label": "Unhappy client"}
          ]
        }
      ]
    },
      ...
      "consequences": [
        {
          ...
          "weight": 70,
          "effects": [
            {"type": "reputation", "amount": 3, "label": "Good relationship"}
          ]
        },
        {
          "id": "expects-more",
          ...
          "weight": 30,
          "effects": [
            {"type": "reputation", "amount": -2, "label": "Boundary issues"}
          ]
        }
      ]
    }
...
-- Event 4: Big Project Opportunity (Opportunity)
INSERT INTO events (id, industry_id, title, category, summary, choices, requirements)
VALUES (
  'big-project',
  'freelance',
      ...
      "consequences": [
        {
          ...
          "effects": [
            ...
            {"type": "reputation", "amount": 10, "label": "Major achievement"}
          ]
        },
        {
          "id": "struggled",
          ...
          "effects": [
            ...
            {"type": "reputation", "amount": -3, "label": "Quality issues"}
          ]
        }
      ]
    },
      ...
      "consequences": [
        {
          ...
          "weight": 50,
          "effects": [
            {"type": "reputation", "amount": 2, "label": "Professionalism"}
          ]
        },
        {
          "id": "fired",
          ...
          "weight": 50,
          "effects": [
            {"type": "reputation", "amount": -5, "label": "Lost client"},
      ...
      "consequences": [
        {
          ...
          "weight": 40,
          "effects": [
            {"type": "reputation", "amount": 1, "label": "Client happy"}
          ]
        },
        {
          "id": "burnout",
          ...
          "weight": 60,
          "effects": [
            {"type": "reputation", "amount": -4, "label": "Quality issues"},
...
-- Event 6: Networking Event (Opportunity)
INSERT INTO events (id, industry_id, title, category, summary, choices, requirements)
VALUES (
  'networking-event',
  'freelance',
      ...
      "consequences": [
        {
          ...
          "weight": 60,
          "effects": [
            {"type": "reputation", "amount": 5, "label": "Networking success"},
...
-- Event 7: Equipment Upgrade Needed (Risk/Opportunity)
INSERT INTO events (id, industry_id, title, category, summary, choices, requirements)
VALUES (
  'equipment-upgrade',
  'freelance',
      ...
      "consequences": [
        {
          ...
          "weight": 100,
          "effects": [
            {"type": "reputation", "amount": -2, "label": "Delayed projects"}
          ]
        }
      ]
    }
...
-- Step 8: Staff Roles (REQUIRED - at least 1 role needed)
...
VALUES 
  (
    ...
    '[
      {"metric": "serviceSpeedMultiplier", "type": "percent", "value": 5},
      {"metric": "founderWorkingHours", "type": "add", "value": -20}
    ]'::jsonb,
    '👩‍💼',
    NULL,
    '[]'::jsonb
  ...
  (
    ...
    '[
      ...
      {"metric": "founderWorkingHours", "type": "add", "value": -30}
    ]'::jsonb,
    '🎨',
    'has-junior-designer',
  ...
  (
    ...
    '[
      ...
      {"metric": "founderWorkingHours", "type": "add", "value": -35}
    ]'::jsonb,
    '💻',
